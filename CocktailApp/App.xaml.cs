        ...
        public App()
        {
            ...
            using (CocktailDataContext database = new CocktailDataContext(DBConnectionString))
            {
                ...
                else
                {
                    ...
                    Mojito.CocktailDate = DateTime.Now;

                    Cocktail PiñaColada = new Cocktail();
                    PiñaColada.CocktailNom = "Piña Colada";
                    ...
                    PiñaColada.CocktailDate = DateTime.Now;

                    Cocktail Margarita = new Cocktail();
                    Margarita.CocktailNom = "Margarita";
                    ...
                    Margarita.CocktailDate = DateTime.Now;

                    Cocktail SexOnTheBeach = new Cocktail();
                    SexOnTheBeach.CocktailNom = "Sex on the Beach";
                    ...
                    SexOnTheBeach.CocktailDate = DateTime.Now;

                    Cocktail BlueLagoon = new Cocktail();
                    BlueLagoon.CocktailNom = "Blue Lagoon";
                    ...
                    BlueLagoon.CocktailDate = DateTime.Now;

                    Cocktail TequilaSunrise = new Cocktail();
                    TequilaSunrise.CocktailNom = "Tequila Sunrise";
                    ...
                    TequilaSunrise.CocktailDate = DateTime.Now;

                    Cocktail Punch = new Cocktail();
                    Punch.CocktailNom = "Punch";
                    ...
                    Punch.CocktailDate = DateTime.Now;

                    Cocktail BloodyMary = new Cocktail();
                    BloodyMary.CocktailNom = "Bloody Mary";
                    ...
                    BloodyMary.CocktailDate = DateTime.Now;

                    Cocktail Monaco = new Cocktail();
                    Monaco.CocktailNom = "Monaco";
                    ...
                    Monaco.CocktailDate = DateTime.Now;

                    Cocktail WhiteRussian = new Cocktail();
                    WhiteRussian.CocktailNom = "White Russian";
                    ...
                    WhiteRussian.CocktailDate = DateTime.Now;

                    Cocktail BoraBora = new Cocktail();
                    BoraBora.CocktailNom = "Bora Bora";
                    ...
                    BoraBora.CocktailDate = DateTime.Now;

                    App.ViewModel.AddCocktail(Mojito);
                    App.ViewModel.AddCocktail(PiñaColada);
                    App.ViewModel.AddCocktail(Margarita);
                    App.ViewModel.AddCocktail(SexOnTheBeach);
                    App.ViewModel.AddCocktail(BlueLagoon);
                    App.ViewModel.AddCocktail(TequilaSunrise);
                    App.ViewModel.AddCocktail(Punch);
                    App.ViewModel.AddCocktail(BloodyMary);
                    App.ViewModel.AddCocktail(Monaco);
                    App.ViewModel.AddCocktail(WhiteRussian);
                    App.ViewModel.AddCocktail(BoraBora);
                }
            }
